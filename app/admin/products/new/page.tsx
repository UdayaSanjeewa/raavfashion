      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Fill in product details, variants and inventory</p>
          </div>
        </div>
      </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <p className="text-xs text-gray-400">Direct MP4 link — auto-plays (muted) on hover on the product page.</p>
              {videoUrl.trim() && (
